...
/**
 * The Client.Logger class is used for the Output of the Programm.
...
class Logger {
    ...
    /**
     * Returns the Instance of the Client.Logger Object. If there is no Instance (the first call) it calls the private Contructor.
